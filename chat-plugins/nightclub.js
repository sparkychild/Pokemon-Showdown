if (!global.nightclubs) global.nightclubs = {};
 ...
 -        return '|raw|<div style = "font-size: 10pt; margin: -3px; padding: 1px; background:black; color: black; text-shadow: 0px 0px 10px, 0px 0px 10px, 0px 0px 10px;">' +
 -                '<small style = "color: white">' + rank + '</small>' +
 -                '<button name = "parseCommand" value = "/user ' + user + '" style = "outline: none; cursor: pointer; font-size: inherit; text-shadow: inherit; font-family: inherit; background: none; padding: 0px; border: none; display: inline-block; color: ' + hashColor(toId(user)) + ';"><b>' + user + ':</b></button>' +
 ...
 -                var style = '|raw|<div style = "color: white; text-shadow: 0px 0px 4px, 0px 0px 6px; background: black; padding: 2px; margin: -3px,">';
 ...
 -                        if (data.split('\n').length > 1) {
 -                                style = '|html|<div style = "border: 4px solid black; margin: -3px">';
 ...
 -                if (!this.can('mute', null, room)) return this.sendReply('You must be ranked % or higher to toggle this room\'s nightclub mode.');
