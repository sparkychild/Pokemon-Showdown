...
exports.commands = {
	nightclub: function(target, room, user, connection) {
		...
		room.addRaw('<div style = "background: black; margin: -3px"><font size=6>' + nightclubify('IDM we in dis!!! nightclub mode: ON!!!') + '</font><font size="2"> started by: ' + user.userid + '</font></div>');
	},
	dayclub: function(target, room, user, connection) {
		...
		room.addRaw('<div style = "background: black; margin: -3px"><font size=6>' + nightclubify('sizzle down now... nightclub mode: off.') + '</font><font size="2"> ended by: ' + user.userid + '</font></font>');
	},
}
