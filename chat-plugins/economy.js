...
exports.commands = {
	...
	shop: function(target, room, user) {
	 	...
	 	this.sendReplyBox('<center><h4><b><u>' + shopTitle + '</u></b></h4><table border="1" cellspacing ="0" cellpadding="3"><tr><th>Item</th><th>Description</th><th>Price</th><th>Buy</th></tr>' +
	 		...
	 		'<tr><td>Fix</td><td>Buys the ability to alter your current custom avatar/trainer card or userlist icon (don\'t buy if you have neither)</td><td>10</td><button name="send" value="/buy fix">Fix</button></tr>' +
			...
			'<tr><td>League Shop</td><td>Buys a shop for any room. (must be roomfounder)</td><td>20</td></tr>' +
