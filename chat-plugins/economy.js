...
exports.commands = {
	...
	shop: function(target, room, user) {
	 	...
	 	this.sendReplyBox('<center><h4><b><u>' + shopTitle + '</u></b></h4><table border="1" cellspacing ="0" cellpadding="3"><tr><th>Item</th><th>Description</th><th>Price</th><th>Buy</th></tr>' +
	 		'<tr><td>Custom Symbol</td><td>Buys a custom symbol to go in front of your name. (Temporary until restart)</td><td>5</td><td><button name="send" value="/buy customsymbol">Custom Symbol!</td></button></tr>' +
